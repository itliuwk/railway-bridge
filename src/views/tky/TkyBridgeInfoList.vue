<template>
  <a-card :bordered="false">
          ...
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="桥梁号">
                <a-input placeholder="请输入桥梁号" v-model="queryParam.bridgeNumber"></a-input>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('tky_bridge_info')">导出</a-button>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'int',value:'bridgeNumber',text:'桥梁号',dictCode:''})
        fieldList.push({type:'string',value:'bridgeName',text:'桥梁名',dictCode:''})
        fieldList.push({type:'string',value:'bridgeOpenCount',text:'桥孔数量',dictCode:''})
        fieldList.push({type:'string',value:'bridgeXingbie',text:'行别',dictCode:''})
        fieldList.push({type:'string',value:'bridgeStartMil',text:'起始里程',dictCode:''})
        fieldList.push({type:'string',value:'bridgeCentreMil',text:'中心里程',dictCode:''})
        fieldList.push({type:'string',value:'bridgeEndMil',text:'终止里程',dictCode:''})
        fieldList.push({type:'string',value:'bridgeLength',text:'全长',dictCode:''})
        fieldList.push({type:'string',value:'bridgeSector',text:'所在区间',dictCode:''})
        fieldList.push({type:'string',value:'bridgeCode',text:'桥梁编码',dictCode:''})
        fieldList.push({type:'string',value:'bridgeType',text:'桥梁类型',dictCode:''})
        fieldList.push({type:'string',value:'bulidBureau',text:'工程局',dictCode:''})
        fieldList.push({type:'string',value:'opreationState',text:'运营状态',dictCode:''})
        fieldList.push({type:'string',value:'buildYear',text:'建成年度',dictCode:''})
        fieldList.push({type:'string',value:'buildDuanNumber',text:'工务段编号',dictCode:''})
