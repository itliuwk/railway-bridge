<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="线名">
              <a-input
                placeholder="请输入线名"
                v-model="queryParam.bridgeInfoLineName"
              ></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="桥梁名称">
              <a-input
                placeholder="请输入桥梁名称"
                v-model="queryParam.bridgeInfoName"
              ></a-input>
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="检测时间">
                <a-input
                  placeholder="请输入检测时间"
                  v-model="queryParam.detectionTime"
                ></a-input>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div>
      ...
      >
        <a slot="imgName" slot-scope="text, record" @click="getImage(record)">{{
          text
        }}</a>
        ...
        <span slot="action" slot-scope="text, record">
          ...
          <a
            v-if="record.typeValue == 'CK' || record.typeValue == 'CC'"
            @click="lenTrend(record)"
          >
            长度趋势
          </a>
          <a-divider
