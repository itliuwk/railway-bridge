<template>
  ...
  >
          <span id="test_3" @mousemove="move" @mouseup="stop" @mouseleave="mouseLeave">
            ...
            <canvas @mousedown="start" id="myCanvas" ref="singleImg" class="originStyle" width="3210" height="1504"></canvas>
          </span>
          <template>
             <span  style="width:150px">
              <a-table
                ...
                :scroll="{ y: 240 }"
              >
                <a slot="detection_time" slot-scope="text, record" @click="getSourceTimeImage(record)">
                  {{text}}
                </a>
              </a-table>
