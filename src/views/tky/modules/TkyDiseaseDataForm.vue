    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="距人行道板距离" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="lengthFromBottom">
              <a-input v-model="model.lengthFromBottom" placeholder="请输入距人行道板距离"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="等级" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="level">
              <a-input v-model="model.level" placeholder="请输入等级"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/moudle/tkyDiseaseData/add",
          edit: "/moudle/tkyDiseaseData/edit",
          queryById: "/moudle/tkyDiseaseData/queryById"
        }
      }
    },
    computed: {
